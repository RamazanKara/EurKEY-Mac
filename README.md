...
The macOS Keyboard Layout for Europeans, Coders and Translators.
...
# Install
Run `brew install eurkey` or
copy the two files under `/releases/` - `EurKEY.keylayout` and `EurKEY.icns` to your library, either system-wide (`/Library/Keyboard Layouts`) or for your local user (`~/Library/Keyboard Layouts`).
